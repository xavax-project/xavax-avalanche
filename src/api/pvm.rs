...
/* ________________________________________ P-Chain Api Json Responses ________________________________________ */
...
/// # issue_tx
/// `Calls pvm.issueTx on the Avalanche node.`
/// 
...
/// # get_utxos
/// `Calls pvm.getUTXOs on the Avalanche node.`
/// 
